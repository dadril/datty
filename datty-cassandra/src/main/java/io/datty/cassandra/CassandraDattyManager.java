...
/**
 * CassandraDattyManager
 * 
 * @author Alex Shvid
 *
 */

public class CassandraDattyManager implements DattyManager {

	public CassandraDattyManager(Properties props) {
