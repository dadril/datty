...
public class MapMessageWriter implements MessageWriter {
	...
	@Override
	public void writeHeader(int size, int maxSize, int headerIndex, ByteBuf sink) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public ByteBuf writeHeader(int size, ByteBuf sink) {
		return null;
	}
