...
public enum ExecuteResultIO implements DattyResultIO<ExecuteResult> {
	...
	@Override
	public boolean readField(ExecuteResult result, DattyField field, MessageReader reader, ByteBuf source) {
	...
	@Override
	public ByteBuf write(ExecuteResult result, MessageWriter writer, ByteBuf sink, boolean numeric) {
