...
public abstract class AbstractUpdateOperationIOTest<O extends AbstractUpdateOperation> extends AbstractDattyIOTest {

	abstract O newOperation();
	
	void assertEmptyFields(O operation) {
	}
	
	void addOtherFields(O operation) {
	}
	
	void assertOtherFields(O expected, O actual) {
	}
